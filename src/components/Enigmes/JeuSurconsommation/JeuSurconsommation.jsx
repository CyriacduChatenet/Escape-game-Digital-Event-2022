...
export const JeuSurconsommation = () => {
  ...
  return (
    <div className="jeuSurconsommationModal">
      {displayLoader ? (
        <video autoPlay className="loader-video">
          <source
            src="assets/video/loader/loader-surconsommation.mp4"
            type="video/mp4"
          />
        </video>
      ) : null}
